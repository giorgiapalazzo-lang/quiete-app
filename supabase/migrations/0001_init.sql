-- Quiete — schema iniziale (Supabase Postgres)
-- Eseguire con: supabase db push   (oppure incollare nel SQL editor di Supabase)
-- Modello: piano -> slot pasto -> opzioni -> componenti -> equivalenze,
-- più antropometria, frequenze, integrazione, diario.
